...
fd_1_o2(amrex::Array4<T const> const &gf, int i, int j, int k, int comp, amrex::GpuArray<T, 3> const &dxi) {
  const T m1 = gf(i + (D == 0 ? -1 : 0), j + (D == 1 ? -1 : 0), k + (D == 2 ? -1 : 0), comp);
  const T p1 = gf(i + (D == 0 ? 1 : 0), j + (D == 1 ? 1 : 0), k + (D == 2 ? 1 : 0), comp);
  return
    (dxi[D]*(-m1 + p1))/2.;
}
...
fd_1_o4(amrex::Array4<T const> const &gf, int i, int j, int k, int comp, amrex::GpuArray<T, 3> const &dxi) {
  const T m2 = gf(i + (D == 0 ? -2 : 0), j + (D == 1 ? -2 : 0), k + (D == 2 ? -2 : 0), comp);
  const T m1 = gf(i + (D == 0 ? -1 : 0), j + (D == 1 ? -1 : 0), k + (D == 2 ? -1 : 0), comp);
  const T p1 = gf(i + (D == 0 ? 1 : 0), j + (D == 1 ? 1 : 0), k + (D == 2 ? 1 : 0), comp);
  const T p2 = gf(i + (D == 0 ? 2 : 0), j + (D == 1 ? 2 : 0), k + (D == 2 ? 2 : 0), comp);
  return
...
fd_1_o6(amrex::Array4<T const> const &gf, int i, int j, int k, int comp, amrex::GpuArray<T, 3> const &dxi) {
  const T m3 = gf(i + (D == 0 ? -3 : 0), j + (D == 1 ? -3 : 0), k + (D == 2 ? -3 : 0), comp);
  const T m2 = gf(i + (D == 0 ? -2 : 0), j + (D == 1 ? -2 : 0), k + (D == 2 ? -2 : 0), comp);
  const T m1 = gf(i + (D == 0 ? -1 : 0), j + (D == 1 ? -1 : 0), k + (D == 2 ? -1 : 0), comp);
  const T p1 = gf(i + (D == 0 ? 1 : 0), j + (D == 1 ? 1 : 0), k + (D == 2 ? 1 : 0), comp);
  const T p2 = gf(i + (D == 0 ? 2 : 0), j + (D == 1 ? 2 : 0), k + (D == 2 ? 2 : 0), comp);
  const T p3 = gf(i + (D == 0 ? 3 : 0), j + (D == 1 ? 3 : 0), k + (D == 2 ? 3 : 0), comp);
  return
...
fd_1_o8(amrex::Array4<T const> const &gf, int i, int j, int k, int comp, amrex::GpuArray<T, 3> const &dxi) {
  const T m4 = gf(i + (D == 0 ? -4 : 0), j + (D == 1 ? -4 : 0), k + (D == 2 ? -4 : 0), comp);
  const T m3 = gf(i + (D == 0 ? -3 : 0), j + (D == 1 ? -3 : 0), k + (D == 2 ? -3 : 0), comp);
  const T m2 = gf(i + (D == 0 ? -2 : 0), j + (D == 1 ? -2 : 0), k + (D == 2 ? -2 : 0), comp);
  const T m1 = gf(i + (D == 0 ? -1 : 0), j + (D == 1 ? -1 : 0), k + (D == 2 ? -1 : 0), comp);
  const T p1 = gf(i + (D == 0 ? 1 : 0), j + (D == 1 ? 1 : 0), k + (D == 2 ? 1 : 0), comp);
  const T p2 = gf(i + (D == 0 ? 2 : 0), j + (D == 1 ? 2 : 0), k + (D == 2 ? 2 : 0), comp);
  const T p3 = gf(i + (D == 0 ? 3 : 0), j + (D == 1 ? 3 : 0), k + (D == 2 ? 3 : 0), comp);
  const T p4 = gf(i + (D == 0 ? 4 : 0), j + (D == 1 ? 4 : 0), k + (D == 2 ? 4 : 0), comp);
  return
